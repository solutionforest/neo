...
//
// Stdin carries an out-of-band resize control frame: "\x1eR<cols>x<rows>\n"
// (0x1e = RS, never produced by a keyboard). Those frames are intercepted and
// turned into WindowChange calls; everything else forwards as keystrokes.
